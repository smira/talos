...
// State implements runtime.V2State interface.
type State struct {
...
func NewState() (*State, error) {
	...
	if err := s.namespaceRegistry.Register(ctx, legacy.NamespaceName, "Legacy Talos subsystems glue resources.", true); err != nil {
		return nil, err
	}
...
// Resources implements runtime.V2State interface.
func (s *State) Resources() state.State {
	return s.resources
}

// NamespaceRegistry implements runtime.V2State interface.
func (s *State) NamespaceRegistry() *registry.NamespaceRegistry {
	return s.namespaceRegistry
}

// ResourceRegistry implements runtime.V2State interface.
func (s *State) ResourceRegistry() *registry.ResourceRegistry {
	return s.resourceRegistry
}

// SetConfig implements runtime.V2State interface.
