...
import (
	...
	"github.com/talos-systems/talos/internal/app/machined/pkg/runtime/v2alpha1"
...
func NewController(b []byte) (*Controller, error) {
	...
	ctlr.v2, err = v2alpha1.NewController(ctlr.r, l)
	if err != nil {
		return nil, err
	}
...
// V2 implements the controller interface.
func (c *Controller) V2() runtime.V2Controller {
	return c.v2
}
